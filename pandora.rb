  ...
  class FieldsDialog < AdvancedDialog
    ...
    class BodyScrolledWindow < Gtk::ScrolledWindow
      ...
      def initialize(*args)
        ...
        #signal_connect('notify') do |*args|
        #  p 'BODYSW===notify: '+args.inspect
        #  false
        #end
    ...
    def initialize(apanobject, afields=[], *args)
      ...
      PandoraGtk.add_tool_btn(toolbar, Gtk::Stock::INDEX, 'Color', true) do |btn|
        ...
        if bw
          ...
          bw.set_buffers
          #if btn.active?
          #  bw.text_view.buffer.text = ''
          #  #bw.text_view.show
          #else
          #  bw.text_view.buffer.text = "sd sdgf dsfgds sd fsd ывап ываыв аыв аыва ываыв аыв ыва ываыв аыв аыв \n"*300
          #  #bw.text_view.hide
          #end
        end
      end
