...
#  end
  ...
  class AdvancedDialog < Gtk::Window #Gtk::Dialog
    ...
    def initialize(*args)
      ...
      image = Gtk::Image.new(:stock => Gtk::Stock::PROPERTIES, :size => :menu)
...
#GTK3      super(*args)
      ...
      button.signal_connect('clicked') do |*args|
        ...
        panclasses.each_with_index do |panclass, i|
          ...
          image = Gtk::Image.new(:stock => Gtk::Stock::INDEX, :size => :menu)
          image.set_padding(2, 0)
...
bodywid = view
                ...
                if bodywid.is_a? Gtk::SourceView #Gtk::TextView
                  textsw.add(bodywid)
                  #set_buffers(true)
                elsif bodywid
      ...
      while i>0 do
        ...
        if (aview=='blob') or (aview=='text')
          ...
          textsw.set_policy(:automatic, :automatic)

          image = Gtk::Image.new(:stock => Gtk::Stock::DND, :size => :menu)
          image.set_padding(2, 0)
      ...
      image = Gtk::Image.new(:stock => Gtk::Stock::DIALOG_AUTHENTICATION, :size => :menu)
      image.set_padding(2, 0)
      ...
      image = Gtk::Image.new(:stock => Gtk::Stock::DIALOG_INFO, :size => :menu)
      image.set_padding(2, 0)
...
#GTK3      super(*args)
      ...
      if child
        ...
        close_image = Gtk::Image.new(:stock => Gtk::Stock::CLOSE, :size => :menu)
        btn.add(close_image)
  ...
  class DialogScrollWin < Gtk::ScrolledWindow
    ...
    def initialize(known_node, a_room_id, a_targets)
      ...
      image = Gtk::Image.new(:stock => Gtk::Stock::MEDIA_PLAY, :size => :menu)
      image.set_padding(2, 0)

      hpaned = Gtk::Paned.new(:horizontal)
      add_with_viewport(hpaned)

      vpaned1 = Gtk::Paned.new(:vertical)
      vpaned2 = Gtk::Paned.new(:vertical)
...
#avplay -bufsize 10 tcp://127.0.0.1:5000
      ...
      talksw.set_policy(:automatic, :automatic)
      talksw.add(talkview)
      ...
      hpaned2 = Gtk::Paned.new(:horizontal)
      ...
      list_sw.set_policy(:never, :automatic)
      ...
      tit_image = Gtk::Image.new(:stock => Gtk::Stock::CONNECT, :size => :menu)
      ...
      hpaned3 = Gtk::Paned.new(:horizontal)
  ...
  def self.create_menu_item(mi, treeview=nil)
    ...
    if mi[0] == '-'
      ...
      if mi[1]
	#menuitem = Gtk::ImageMenuItem.new(:label => mi[1])
	menuitem = Gtk::ImageMenuItem.new(:label => text, :stock_id => mi[1])
        #label = menuitem.children[0]
      ...
      if (not treeview) and mi[3]
        ...
        menuitem.add_accelerator('activate', $group, key, mod, :visible) if key
      end
      menuitem.name = mi[0]
  ...
  def self.add_tool_btn(toolbar, stock, title, toggle=nil)
    btn = nil
    if toggle != nil
#GTK3      btn = SafeToggleToolButton.new(stock)
      btn = SafeToggleToolButton.new()
      btn.safe_signal_clicked do |*args|
        yield(*args) if block_given?
      end
      btn.active = toggle if toggle
    else
      image = Gtk::Image.new(:stock => stock, :size => :menu)
      btn = Gtk::ToolButton.new(:icon_widget => image, :label => _(title))
    ...
    def self.get_panobject_icon(panobj)
      ...
      if ind
        ...
        if first_lab_widget.is_a? Gtk::Image
          ...
          panobj_icon = $window.render_icon(image.stock, :size => :menu).dup
        end
      end
      panobj_icon
    end
  ...
  def self.show_panobject_list(panobject_class, widget=nil, sw=nil, auto_create=false)
    ...
    if single
      ...
      image = nil
      if animage
        image = Gtk::Image.new(animage.stock, :size => :menu)
        image.set_padding(2, 0)
      end
...
=end
  ...
  def self.show_search_panel(text=nil)
    ...
    image = Gtk::Image.new(:stock => Gtk::Stock::FIND, :size => :menu)
    image.set_padding(2, 0)
  ...
  def self.show_profile_panel(a_person=nil)
    ...
    image = Gtk::Image.new(:stock => Gtk::Stock::HOME, :size => :menu)
    image.set_padding(2, 0)
  ...
  def self.show_session_panel(session=nil)
    ...
    image = Gtk::Image.new(:stock => Gtk::Stock::JUSTIFY_FILL, :size => :menu)
    image.set_padding(2, 0)
  ...
  class PandoraStatusIcon < Gtk::StatusIcon
    ...
    a_flash_interval=0, a_play_sounds=true, a_hide_on_minimize=true)
      ...
      atitle = $window.title
      set_title(atitle)
#GTK3      set_tooltip(atitle)
      set_tooltip_text(atitle)
    ...
    def create_menu
      ...
      menuitem = Gtk::ImageMenuItem.new(:stock_id => Gtk::Stock::PROPERTIES)
      ...
      menuitem = Gtk::ImageMenuItem.new(:stock_id => Gtk::Stock::QUIT)
      alabel = menuitem.children[0]
  ...
  class CaptchaHPaned < Gtk::Paned
    ...
    def initialize(first_child)
      ...
      self.pack1(@first_child, :resize => true, :shrink => true)
      @csw = nil
    end
  ...
  class MainWindow < Gtk::Window
    ...
    def add_status_field(index, text)
      $statusbar.pack_start(Gtk::SeparatorToolItem.new, :expand => false, :fill => false, :padding => 0) if ($status_fields != [])
      ...
      $statusbar.pack_start(btn, :expand => false, :fill => false, :padding => 0)
...
#GTK3      vpaned = Gtk::VPaned.new
      vpaned = Gtk::Paned.new(:vertical)
      vpaned.border_width = 2
      vpaned.pack1(notebook, :resize => true, :shrink => true)
      vpaned.pack2(sw, :resize => false, :shrink => true)
      ...
      vbox.pack_start(cvpaned, :expand => true, :fill => true, :padding => 0)
      vbox.pack_start($statusbar, :expand => false, :fill => false, :padding => 0)

      #dat = DateEntry.new
      #vbox.pack_start(dat, :expand => false, :fill => false, :padding => 0)
